	...
	<?php if ( ! $key ) { ?>
		...
		if ( is_wp_error( $result ) && in_array( $result->get_error_code(), $valid_error_codes, true ) ) {
			...
			if ( '' === $signup->domain . $signup->path ) {
				printf(
					/* translators: 1: LoginController URL, 2: Username, 3: User email address, 4: Lost password URL. */
			...
			if ( $url && network_home_url( '', 'http' ) !== $url ) :
				...
				<p class="view">
				<?php
					/* translators: 1: Site URL, 2: LoginController URL. */
			...
			<?php else : ?>
				...
				<?php
					printf(
						/* translators: 1: LoginController URL, 2: Network home URL. */
