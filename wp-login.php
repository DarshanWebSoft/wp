 ...
 * @since 2.1.0
 *
 * @global string      $error         LoginController error message set by deprecated pluggable wp_login() function
...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	/* translators: LoginController screen title. 1: LoginController screen name, 2: Network or site name. */
	$login_title = sprintf( __( '%1$s &lsaquo; %2$s &#8212; WordPress' ), $title, $login_title );

	if ( wp_is_recovery_mode() ) {
		/* translators: %s: LoginController screen title. */
	 ...
	 * @since 2.1.0
	 *
	 * @param string $login_header_url LoginController header logo URL.
	 */
	 ...
	 *
	 * @param string $login_header_title LoginController header logo title attribute.
	 */
	 ...
	 * @since 2.1.0
	 *
	 * @param string $message LoginController message text.
	 */
	...
	if ( $wp_error->has_errors() ) {
		...
		if ( ! empty( $errors ) ) {
			 ...
			 * @since 2.1.0
			 *
			 * @param string $errors LoginController error message.
			 */
		...
		if ( ! empty( $messages ) ) {
			 ...
			 * @since 2.5.0
			 *
			 * @param string $messages LoginController messages.
			 */
